package tasks.sixth.test;

import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import tasks.sixth.java.MichaelScottQueue;
...
class MichaelScottQueueTest {
    ...
    void shouldAddElementsFromDifferentThreads() throws InterruptedException {
        ...
        for (int i = 2; i < 8; i++) {
            Assertions.assertTrue(resultsAfterRemove.contains(i));
        }
    }
    ...
    void shouldRemoveElementsFromDifferentThreads() throws InterruptedException {
        ...
        Assertions.assertNull(michaelScottQueue.dequeue());
        Assertions.assertTrue(dequeueResult == 2 || dequeueResult == 4 || dequeueResult == 6);
    }
